...
export class CompleteForm implements ComponentFramework.StandardControl<IInputs, IOutputs> {
	...
	private GetAttributes() {
		this._noneNulls = Xrm.Page.getAttribute().filter(f => f.getRequiredLevel() == "none" && !f.getValue());
		this._noneNotNulls = Xrm.Page.getAttribute().filter(f => f.getRequiredLevel() == "none" && f.getValue());
		this._recommendedNulls = Xrm.Page.getAttribute().filter(f => f.getRequiredLevel() == "recommended" && !f.getValue());
		this._recommendedNotNulls = Xrm.Page.getAttribute().filter(f => f.getRequiredLevel() == "recommended" && f.getValue());
		this._requiredNulls = Xrm.Page.getAttribute().filter(f => f.getRequiredLevel() == "required" && !f.getValue());
		this._requiredNotNulls = Xrm.Page.getAttribute().filter(f => f.getRequiredLevel() == "required" && f.getValue());
	}
